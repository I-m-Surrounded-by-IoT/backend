...
var file_collection_collection_proto_goTypes = []interface{}{
	...
	(*waterquality.Quality)(nil),             // 13: api.waterquality.Quality
...
var file_collection_collection_proto_depIdxs = []int32{
	13, // 0: api.collection.CreateCollectionRecordReq.data:type_name -> api.waterquality.Quality
	13, // 1: api.collection.CollectionRecord.data:type_name -> api.waterquality.Quality
	...
	13, // 5: api.collection.DeviceLastReport.data:type_name -> api.waterquality.Quality
