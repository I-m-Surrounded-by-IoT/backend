...
func (c *notifyClient) NotifyTestEmail(ctx context.Context, in *NotifyTestEmailReq, opts ...grpc.CallOption) (*Empty, error) {
	...
	out := new(Empty)
	err := c.cc.Invoke(ctx, Notify_NotifyTestEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notifyClient) NotifyDeviceOnline(ctx context.Context, in *NotifyDeviceOnlineReq, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Notify_NotifyDeviceOnline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notifyClient) NotifyDeviceOffline(ctx context.Context, in *NotifyDeviceOfflineReq, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Notify_NotifyDeviceOffline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
