...
func Server(cmd *cobra.Command, args []string) {
	...
	err := utils.InitTracer(bc.Server.TracingEndpoint, "message")
	if err != nil {
	...
	app, cleanup, err := wireApp(bc.Server, bc.Registry, bc.Database, bc.Config, bc.Kafka, bc.Redis, logger)
	if err != nil {
...
func init() {
	MessageCmd.PersistentFlags().StringVarP(&flagconf, "conf", "c", "", "config path, eg: -c config.yaml")
}
