...
function FixArgs() {
    ...
    LDFLAGS="$LDFLAGS \
        -X 'github.com/I-m-Surrounded-by-IoT/backend/cmd/flags/config.Version=$VERSION' \
        -X 'github.com/I-m-Surrounded-by-IoT/backend/cmd/flags/config.GitCommit=$GIT_COMMIT'"
